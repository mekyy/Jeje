...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = [`${client.guilds.size} Server`,'Ghelp','Type Ghelp Gsupport',`${client.users.size} Members`,'X.inv','By: ! Error'];
    var i = -1;
    var j = 0;
...
if (message.author.id !== '510087749378899968') return message.reply('** هذا الأمر فقط لصاحب البوت و شكراًً **')
client.user.setGame(argresult);
...
client.on('message', message => {
if(message.content.includes("<@510087749378899968>")) {
